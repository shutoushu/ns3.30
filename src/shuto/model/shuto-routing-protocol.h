...
public:
  ...
  static std::vector<int> cancelBR; //ブロードキャストのキャンセル数
...
private:
  ...
  int8_t hopcount, int32_t time,int8_t danger, int32_t myposx, int32_t myposy,
  int32_t pastmyposx, int32_t pastmyposy);//IDを受け取ったときのブロードキャスト
  
  void ReSendXBroadcast(int32_t id, int32_t posx,int32_t posy, 
  int8_t hopcount, int32_t time,int8_t danger, int32_t myposx, int32_t myposy,
  int32_t pastmyposx, int32_t pastmyposy);
