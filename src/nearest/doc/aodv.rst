...
Class ``ns3::nearest::RoutingProtocol`` implements all functionality of 
...
forwarding.  The first one, ``ns3::nearest::RouteOutput``, is used for 
locally originated packets, and the second one, ``ns3::nearest::RouteInput``,
...
this functionality are attributes of ``ns3::nearest::RoutingProtocol``. 
