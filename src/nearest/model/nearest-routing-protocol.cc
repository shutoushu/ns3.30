...
#include "nearest-routing-protocol.h"
#include "ns3/log.h"
...
NS_LOG_COMPONENT_DEFINE ("NearestRoutingProtocol");
...
{
  static TypeId tid =
      TypeId ("ns3::nearest::RoutingProtocol")
...
RoutingProtocol::NotifyInterfaceUp (uint32_t i)
{
  ...
  /*  for (uint32_t i = 0; i < m_ipv4->GetNInterfaces (); i++)
        ...
        //  std::cout<<"############### "<<addr<<" |ninterface "<<m_ipv4->GetNInterfaces ()<<"\n";
              ...
              InetSocketAddress inetAddr (m_ipv4->GetAddress (i, 0).GetLocal (), NEAREST_PORT);
