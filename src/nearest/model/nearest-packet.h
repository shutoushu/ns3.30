 ...
 */
#ifndef NEARESTPACKET_H
#define NEARESTPACKET_H
...
*/
enum MessageType {
  NEARESTTYPE_RREQ = 1, //!< NEARESTTYPE_RREQ
  NEARESTTYPE_RREP = 2, //!< NEARESTTYPE_RREP
  NEARESTTYPE_RERR = 3, //!< NEARESTTYPE_RERR
  NEARESTTYPE_RREP_ACK = 4, //!< NEARESTTYPE_RREP_ACK
  NEARESTTYPE_HELLO = 5
};
...
public:
  /**
   * constructor
   * \param t the NEAREST RREQ type
   */
  TypeHeader (MessageType t = NEARESTTYPE_HELLO);
