 ...
 */
class SampleHelper : public Ipv4RoutingHelper
{
public:
  SampleHelper ();

  /**
   * \returns pointer to clone of this SampleHelper
   *
   * \internal
   ...
   *
   * This method controls the attributes of ns3::sample::RoutingProtocol
   */
