...
int main (int argc, char *argv[])
{
  ...
  UintegerValue ctsThr = (true ? UintegerValue (100) : UintegerValue (2200));
   ...
   wifiChannelHelper.AddPropagationLoss ("ns3::RangePropagationLossModel", "MaxRange", DoubleValue(200));
  ...
  ////////////////////////   INTERNET STACK /////////////////////////
   ...
   ipv4.SetBase ("10.0.0.0", "255.255.254.0");
