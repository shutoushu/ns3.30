...
NetSim::ConfigureDataLinkLayer (bool verbose, StringValue phyMode, double dist)
{
  ...
  for (uint32_t i = 0; i < nWifiNodes; ++i) //nzwifiNode = x のとき０〜ｘ−３個生成
    {
      positionAlloc->Add (Vector (0.0, 0.0, 0.0)); // ni's position id=0
    }
  ...
  Waypoint wpt_start (Seconds (5.0), Vector (180.0, 0.0, 0.0));
  ...
  Waypoint wpt_start2 (Seconds (5.0), Vector (190.0, 0.0, 0.0));
  ...
  Waypoint wpt_start3 (Seconds (5.0), Vector (200.0, 00.0, 0.0));
  ...
  Waypoint wpt_start4 (Seconds (5.0), Vector (210.0, 0.0, 0.0));
  ...
  Waypoint wpt_start5 (Seconds (5.0), Vector (220.0, 0.0, 0.0));
  ...
  Waypoint wpt_start6 (Seconds (5.0), Vector (230.0, 0.0, 0.0));
  ...
  Waypoint wpt_start7 (Seconds (5.0), Vector (240.0, 0.0, 0.0));
  ...
  Waypoint wpt_start8 (Seconds (5.0), Vector (250.0, 0.0, 0.0));
  ...
  Waypoint wpt_start9 (Seconds (5.0), Vector (260.0, 600.0, 0.0));
...
main (int argc, char *argv[])
{
  ...
  std::string animFile = "topologytest"; //netanim
